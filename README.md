...
- **`last_search`** (or **`ls`**): Prints the results of the last album or track search performed, or the last use of `tracks_in_album` or `list_albums`. Use with `queue_search_number` to add specific items to the queue.
