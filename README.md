...
- **`stop`**: Stop playback.
- **`stop_all`**: Stop playback on all speakers in the system. (Note: only pauses speakers that are in the same Sonos Household.)
